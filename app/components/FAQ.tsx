...
const FAQ = () => {
  const [openItem, setOpenItem] = React.useState("item-1"); // First item open by default
  ...
  //     {
  //       id: "item-1",
  //       question: "How does TrustFlow bridge assets?",
  //       answer:
  //         "We integrate with top bridge protocols and smart routing that handle cross-chain transactions across supported blockchains. This lets you move assets seamlessly between different networks with optimal rates and security.",
  //     },
  //     {
  //       id: "item-2",
  //       question: "Is TrustFlow safe?",
  //       answer:
  //         "Yes, TrustFlow prioritizes security. We never store your funds. All transactions occur directly from your wallet to verified contracts. Our platform undergoes regular security audits and uses industry-standard protocols.",
  //     },
  //     {
  //       id: "item-3",
  //       question: "What networks are supported?",
  //       answer:
  //         "TrustFlow supports major blockchains including Ethereum, Polygon, Arbitrum, Optimism, BNB Chain, and many more. We continuously add new networks based on user demand and security standards.",
  //     },
  //     {
  //       id: "item-4",
  //       question: "How much do transactions cost?",
  //       answer:
  //         "Transaction costs include network gas fees plus a small service fee. Our smart routing finds the most cost-effective paths for your trades. Fees are always displayed upfront before confirming any transaction.",
  //     },
  //   ];
